/**
 * ==============================================================================
 * MOTOR DE JUEGO: EXPLOTAR BURBUJAS / GLOBOS
 * ==============================================================================
 * Objetivo del programa:
 * Este motor gestiona un minijuego donde los elementos aparecen de forma 
 * autónoma desde la parte inferior de la pantalla y flotan hacia arriba. 
 * El jugador debe tocarlos para "explotarlos" y ganar puntos.
 *
 * Qué aprenderás de Kotlin y programación con este código:
 * 1. Gestión de estados complejos: Uso de variables booleanas (`explotado`) 
 * para cambiar el comportamiento de un objeto vivo a inerte.
 * 2. Generación procedimental: Creación automática y aleatoria de elementos
 * usando probabilidades (`Random.nextFloat() < 0.05`).
 * 3. Físicas invertidas: Aplicación de aceleración para simular flotabilidad.
 * 4. Limpieza de memoria (Garbage Collection manual): Uso de `removeAll` con 
 * condiciones Lambda para borrar elementos que ya no se ven en pantalla.
 * ==============================================================================
 */
