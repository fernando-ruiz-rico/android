...
fun NavigationRoot(
  ...
  val listaProductosViewModel: ListaProductosViewModel = koinViewModel()
  ...
  NavDisplay(
    ...
    entryProvider = entryProvider {
      ...
      entry<Link.ProductDetail> { link ->
        // Con parametersOf le podemos pasar parámetros al viewModel
        val detalleProductoViewModel: DetalleProductoViewModel = koinViewModel { parametersOf(link) }
